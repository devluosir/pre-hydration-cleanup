...
export const packageInfo = {
  name: '@roger/pre-hydration-cleanup',
  version: '1.0.0',
 ...
 * This enables usage like: npx @roger/pre-hydration-cleanup
 */
export function cli() {
  ...
  if (args.includes('--help') || args.includes('-h')) {
    console.log(`
@roger/pre-hydration-cleanup CLI

Usage:
  npx @roger/pre-hydration-cleanup [options]
...
Examples:
  ...
  npx @roger/pre-hydration-cleanup --attrs "custom-attr1,custom-attr2"
  npx @roger/pre-hydration-cleanup --format json --output cleanup.json
  npx @roger/pre-hydration-cleanup --env-override
    `);
    return;
  }
  ...
  switch (format) {
    ...
    case 'module':
      output = `// Generated by @roger/pre-hydration-cleanup v${packageInfo.version}
